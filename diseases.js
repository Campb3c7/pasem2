(function () {
  ...
  function renderHome() {
    ...
    var html = '<div class="diseases-heading"><p class="eyebrow">Comprehensive disease review</p><h2>Diseases</h2><p>Every disease you need to identify, diagnose, and treat -- organized lecture by lecture, tracked disease by disease. Separate from Disease Walkthrough: this is depth on one disease at a time, not a diagnostic mystery.</p><span class="diseases-count-pill">' + totalDiseases + ' diseases across ' + lectures.length + ' lectures</span></div><div class="disease-lecture-grid">';
